...
def menu():
    ...
    print '\033[0;93mAUTHOR   : Baizid Bostami'

    print '\033[0;94mFACEBOOK : Baizid Bostami'

    print '\033[0;96mGITHUB   : Baizid Bostami'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;91m[]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
